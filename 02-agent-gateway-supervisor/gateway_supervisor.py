...
# -*- coding: utf-8 -*-
"""
Внешний сторож-супервизор гейтвея Hermes ПОД SYSTEMD (hermes-agent-gateway.service).
...
Лечение нездоровья — ТОЛЬКО systemctl:
  1) `systemctl restart hermes-agent-gateway.service` (polkit: hermes разрешён на
     hermes-agent-gateway/.dashboard.service — правило 49-hermes-hermes.rules);
...
transient cron-scope): юнит hermes-agent-dashboard.service самовосстанавливается
...
UNIT_GW = "hermes-agent-gateway.service"
UNIT_DASH = "hermes-agent-dashboard.service"
