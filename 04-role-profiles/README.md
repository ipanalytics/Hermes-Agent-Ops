...
Everyone building multi-agent systems drowns in role chaos. A copy-paste template with sane boundaries plus a file-bridge pattern is immediately useful.
