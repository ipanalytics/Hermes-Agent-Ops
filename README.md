...
| `21-blind-spot-audit` | Measures the share of accepted output a strong judge finds wrong: weekly random sample, redaction, rubric, one recommended change per report. |
